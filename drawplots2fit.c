...
#include <iostream>
 ...
 //--------------------
  ...
  //==========================================================================================
   ...
   void drawplots2fit( const char* histnamepat = "", bool arg_savePdf = true, const char* infile = "plots2.root", bool arg_recycleCanvas=false ) {
  ...
  //==========================================================================================
   ...
   void drawSet( const char* hname_base, const char* xtitle ) {
      ...
      TLegend* legend = new TLegend( 0.80, 0.47, 0.95, 0.67 ) ;
