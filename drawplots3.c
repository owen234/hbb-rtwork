...
#include <iostream>
 ...
 //--------------------
  ...
  //==========================================================================================
   ...
   void drawplots3( const char* histnamepat = "", bool arg_savePdf = true, const char* infile = "plots3.root", bool arg_recycleCanvas=false ) {
       ...
       sprintf( histnamelist[hind], "h_metsig_sigmass_b50" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sigmass_b20" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sigmass_cb" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;

       sprintf( histnamelist[hind], "h_metsig_sigmass_3b_b50" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sigmass_3b_b20" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sigmass_3b_cb" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;

       sprintf( histnamelist[hind], "h_metsig_sigmass_2b_b50" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sigmass_2b_b20" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sigmass_2b_cb" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;

       sprintf( histnamelist[hind], "h_metsig_sbmass_b50" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sbmass_b20" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sbmass_cb" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;

       sprintf( histnamelist[hind], "h_metsig_sbmass_3b_b50" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sbmass_3b_b20" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sbmass_3b_cb" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;

       sprintf( histnamelist[hind], "h_metsig_sbmass_2b_b50" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
       sprintf( histnamelist[hind], "h_metsig_sbmass_2b_b20" ) ; sprintf( histxtitlelist[hind], "METsig" ) ; hind++ ;
