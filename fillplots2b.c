 ...
 //---------------------------
  ...
  //======================================================================
   ...
   //--- METsig
     ...
     //--- 1 lepton
      sprintf( cuts, "(%s)&&(%s)&&(%s)&&(nElectrons+nMuons==1)", btagcuts, masscuts, dphicut ) ;
      bookset( "h_metsig_1lep", "METsig, 1 lepton", bins, xl, xh ) ;
      fillset( "h_metsig_1lep", varstring, cuts ) ;

     //--- 3 btag
      sprintf( cuts, "(%s)&&(%s)&&(%s)&&(CSVbest2>0.898&&CSVbest3>0.679&&CSVbest4<0.244)", masscuts, dphicut, leptonveto ) ;
      bookset( "h_metsig_3btag", "METsig, 3 btag", bins, xl, xh ) ;
      fillset( "h_metsig_3btag", varstring, cuts ) ;

     //--- 2 btag
      sprintf( cuts, "(%s)&&(%s)&&(%s)&&(CSVbest2>0.898&&CSVbest3<0.244&&CSVbest4<0.244)", masscuts, dphicut, leptonveto ) ;
      bookset( "h_metsig_2btag", "METsig, 2 btag", bins, xl, xh ) ;
      fillset( "h_metsig_2btag", varstring, cuts ) ;

     //--- 1 lepton, 3 btag
      sprintf( cuts, "(%s)&&(%s)&&(nElectrons+nMuons==1)&&(CSVbest2>0.898&&CSVbest3>0.679&&CSVbest4<0.244)", masscuts, dphicut ) ;
      bookset( "h_metsig_1lep3btag", "METsig, 1 lepton, 3 btag", bins, xl, xh ) ;
      fillset( "h_metsig_1lep3btag", varstring, cuts ) ;

     //--- 1 lepton, 2 btag
      sprintf( cuts, "(%s)&&(%s)&&(nElectrons+nMuons==1)&&(CSVbest2>0.898&&CSVbest3<0.244&&CSVbest4<0.244)", masscuts, dphicut ) ;
      bookset( "h_metsig_1lep2btag", "METsig, 1 lepton, 2 btag", bins, xl, xh ) ;
      fillset( "h_metsig_1lep2btag", varstring, cuts ) ;

      saveHist( "plots2b.root", "h*" ) ;
